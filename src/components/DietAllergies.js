...
class DietAllergies extends Component {
	...
	componentDidMount(){
        tracker.trackScreenView("DietAllergies");
	}
	...
	render () {
		...
		return (
			<View style={container}>
				...
				<ScrollView>
					{DietAllergies.renderSectionTitle('Diet')}
					<View style={elementContainer}>
						<Text>Your preference</Text>
						<Text style={disText}>Vegan</Text>
					</View>
					{DietAllergies.renderSectionTitle('Allergies & Restrictions')}
